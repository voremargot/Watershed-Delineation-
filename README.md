...
Before running the code, read Delineation_of_watersheds.docx to understand the steps that are being executed. The steps in this file are related to the Nechako Watershed in British Columbia, Canada but can be extrapolated to any area.
